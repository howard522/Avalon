...
mixin _$GameState {
 ...
 GamePhase get phase; List<Player> get players; int get leaderIndex; int get revealIndex; List<int> get proposedTeam; int get rejectStreak;// 新增：連續否決計數
 List<bool> get missionVotes; int get goodScore; int get evilScore; int? get assassinationTargetIndex; bool get isAssassinationSuccess;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,phase,const DeepCollectionEquality().hash(players),leaderIndex,revealIndex,const DeepCollectionEquality().hash(proposedTeam),rejectStreak,const DeepCollectionEquality().hash(missionVotes),goodScore,evilScore,assassinationTargetIndex,isAssassinationSuccess);

@override
String toString() {
  return 'GameState(phase: $phase, players: $players, leaderIndex: $leaderIndex, revealIndex: $revealIndex, proposedTeam: $proposedTeam, rejectStreak: $rejectStreak, missionVotes: $missionVotes, goodScore: $goodScore, evilScore: $evilScore, assassinationTargetIndex: $assassinationTargetIndex, isAssassinationSuccess: $isAssassinationSuccess)';
}
...
@useResult
$Res call({
 GamePhase phase, List<Player> players, int leaderIndex, int revealIndex, List<int> proposedTeam, int rejectStreak, List<bool> missionVotes, int goodScore, int evilScore, int? assassinationTargetIndex, bool isAssassinationSuccess
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( GamePhase phase,  List<Player> players,  int leaderIndex,  int revealIndex,  List<int> proposedTeam,  int rejectStreak,  List<bool> missionVotes,  int goodScore,  int evilScore,  int? assassinationTargetIndex,  bool isAssassinationSuccess)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameState() when $default != null:
return $default(_that.phase,_that.players,_that.leaderIndex,_that.revealIndex,_that.proposedTeam,_that.rejectStreak,_that.missionVotes,_that.goodScore,_that.evilScore,_that.assassinationTargetIndex,_that.isAssassinationSuccess);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( GamePhase phase,  List<Player> players,  int leaderIndex,  int revealIndex,  List<int> proposedTeam,  int rejectStreak,  List<bool> missionVotes,  int goodScore,  int evilScore,  int? assassinationTargetIndex,  bool isAssassinationSuccess)  $default,) {final _that = this;
switch (_that) {
case _GameState():
return $default(_that.phase,_that.players,_that.leaderIndex,_that.revealIndex,_that.proposedTeam,_that.rejectStreak,_that.missionVotes,_that.goodScore,_that.evilScore,_that.assassinationTargetIndex,_that.isAssassinationSuccess);case _:
  throw StateError('Unexpected subclass');
...
class _GameState implements GameState {
  const _GameState({this.phase = GamePhase.setup, final  List<Player> players = const <Player>[], this.leaderIndex = 0, this.revealIndex = 0, final  List<int> proposedTeam = const <int>[], this.rejectStreak = 0, final  List<bool> missionVotes = const <bool>[], this.goodScore = 0, this.evilScore = 0, this.assassinationTargetIndex, this.isAssassinationSuccess = false}): _players = players,_proposedTeam = proposedTeam,_missionVotes = missionVotes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,phase,const DeepCollectionEquality().hash(_players),leaderIndex,revealIndex,const DeepCollectionEquality().hash(_proposedTeam),rejectStreak,const DeepCollectionEquality().hash(_missionVotes),goodScore,evilScore,assassinationTargetIndex,isAssassinationSuccess);
